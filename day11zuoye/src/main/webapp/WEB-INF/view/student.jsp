...
<body class="gray-bg">
	...
	<div class="modal fade" id="modal_user_addCourse" role="dialog" aria-labelledby="modal_user_addCourse" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user1" method="post" action="addCourse.htm">
						<input type="hidden" name="cid" id="hidden_txt_cid" value=""/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>专业名称：</td>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addCourse").click(function(){
	    		$('#password').attr("readOnly",false).val(getSelection.password);
	    		$("#form_user1").resetForm();
	    		document.getElementById("hidden_txt_cid").value='';
			...
			$.ajax({
			    ...
			    success:function(res){
			    	...
			    	res.data.forEach(function(studentVo) {
						...
						xdata.push(studentVo.cname);
						ydata.push({value:studentVo.num,name:studentVo.cname});
					});
